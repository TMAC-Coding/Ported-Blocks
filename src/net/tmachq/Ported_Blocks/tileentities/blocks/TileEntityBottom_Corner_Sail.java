...
public class TileEntityBottom_Corner_Sail extends BlockContainer {
    
    public TileEntityBottom_Corner_Sail(int id) {
    ...
    public TileEntity createNewTileEntity(World world) {
            return new TileEntityBottom_Corner_SailEntity();
    }
