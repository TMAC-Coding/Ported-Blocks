...
public class TileEntityVoidstoneColumn extends BlockContainer {
    
    public TileEntityVoidstoneColumn(int id) {
    ...
    public TileEntity createNewTileEntity(World world) {
            return new TileEntityVoidstoneColumnEntity();
    }
    ...
    public void registerIcons(IconRegister icon) {
        this.blockIcon = icon.registerIcon("ported_blocks:Voidstone_Column");
    }
